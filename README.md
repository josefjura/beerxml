...
*   `docs/`: Documentation and Specifications (Website Source).

    *   `spec/v1.0/`: **BeerXML 1.0 (Legacy)**

        *   `v1.0.md`: Markdown specification.

        *   `beerxml-1.0.xsd`: Original XSD.

    *   `spec/v1.1/`: **BeerXML 1.1 (Draft)** - Modern "Clean XML" evolution.
...
*   [BeerXML 1.0 Spec](docs/spec/v1.0/v1.0.md)

*   [BeerXML 1.1 Spec (Draft)](docs/spec/v1.1/v1.1.md)

*   **BeerXML 1.1 Goals**: See [RFC 01](docs/spec/v1.1/RFC_01_goals.md)
